  ...
  (function(f, m) {
    (m.editor = m.editor || {}),
      (window.switchEditors = new function() {
          ...
          !s &&
            ...
            (d = s.$)(document).on("click", function(e) {
              ...
              t.hasClass("wp-switch-editor") &&
                r(
                  t.attr("data-wp-editor-id"),
                  t.hasClass("switch-tmce") ? "tmce" : "html"
                );
            }));
        }
        function u(e) {
              ...
              (function(e) {
                ...
                var t = e[0],
                  n = (function(e, t) {
                    ...
                    c &&
                      !c.showAsPlainText &&
                      (r = c.urlAtEndOfContent ? c.startIndex : c.endIndex);
              ...
              i.getParam("wp_keep_scroll_position") &&
                (p = (function(e) {
                  ...
                  var f = u.index,
                    ...
                    h = null;
                  if (w) {
                    -1 !== u[0].indexOf("data-mce-object-selection") &&
                      (m -= u[1].length);
                    var v = w.index;
                    -1 !== w[0].indexOf("data-mce-object-selection") &&
                      (v -= w[1].length),
                      (h = v - m);
                  }
        ...
        return (
          f(document).on("tinymce-editor-init.keep-scroll-position", function(
            e,
            t
          ) {
      ...
      (m.editor.initialize = function(e, t) {
        ...
        if (f && e && m.editor.getDefaultSettings) {
          if (
            ((r = m.editor.getDefaultSettings()),
            (t = t || { tinymce: !0 }).tinymce && t.quicktags)
          ) {
            var i = f("#" + e),
              a = f("<div>").attr({

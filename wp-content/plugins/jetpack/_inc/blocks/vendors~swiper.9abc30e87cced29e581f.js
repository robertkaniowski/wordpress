              ...
              if (
                ...
                if (!u || !(h <= c || h >= i.screen.width - c)) {
                  if (
                    ...
                    var f =
                      v && this.allowTouchMove && a.touchStartPreventDefault;
              ...
              if (
                ...
                if (
                  !(
                    ...
                    Math.sqrt(Math.pow(u, 2) + Math.pow(c, 2)) <
                      this.params.threshold
                  )
                )
                  if (
                    (void 0 === i.isScrolling &&
                      ...
                      (this.isVertical() && a.currentX === a.startX)
                        ...
                        : u * u + c * c >= 25 &&
                          ((p =
                            (180 * Math.atan2(Math.abs(c), Math.abs(u))) /
                            Math.PI),
        ...
        var B = {
          ...
          ce = [
            ...
            },
            {
              ...
              create: function() {
                M(this, {
                  autoplay: t(t({}, le), {}, { running: !1, paused: !1 })
                });
              },
              on: {
                init: function(e) {

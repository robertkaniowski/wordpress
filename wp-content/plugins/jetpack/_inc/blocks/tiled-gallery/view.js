  ...
  (function(t) {
    ...
    26: function(t, e, n) {
      ...
      var r = ["image"],
        ...
        f = "rectangular",
        h = "square",
        l = [{ isDefault: !0, name: f }, { name: a }, { name: h }, { name: s }];
    },
    423: function(t, e, n) {
      n(49), (t.exports = n(424));
    },
    424: function(t, e, n) {
      "use strict";
      n.r(e);
      var r = n(50),
        ...
        u = n(86);
      function c(t) {
        c.pendingRaf && cancelAnimationFrame(c.pendingRaf),
          (c.pendingRaf = requestAnimationFrame(function() {
            c.pendingRaf = null;
            var e = !0,
              n = !1,
              r = void 0;
              ...
              for (
                var i,
                  o = function() {
                    ...
                    Array.from(
                      t.target.querySelectorAll(".tiled-gallery__row")
                    ).forEach(function(t) {
        ...
        i()(function() {
          var t = Array.from(
            document.querySelectorAll(
              ".wp-block-jetpack-tiled-gallery.is-style-rectangular > .tiled-gallery__gallery,.wp-block-jetpack-tiled-gallery.is-style-columns > .tiled-gallery__gallery"
            )
          );
          if (0 !== t.length) {
            var e = new o.a(c);
      ...
      function v(t) {
        ...
        if (
          ("border-box" === r.boxSizing &&
            ...
            Math.round(a + u) !== n && (a -= p(r, "top", "bottom") + u)),
          !(function(t) {
          ...
          var s = Math.round(c + o) - e,
            f = Math.round(a + u) - n;
          1 !== Math.abs(s) && (c -= s), 1 !== Math.abs(f) && (a -= f);
        }
    ...
    86: function(t, e, n) {
      ...
      function c(t, e) {
        return (function(t, e, n) {
          var r = i()(e, 2),
            c = r[0],
            a = r[1],
            d = (1 / c) * (n - o.b * (t.childElementCount - 1) - a);
          return (function(t, e) {
            var n = e.rawHeight,
              r = e.rowWidth,
              i = s(t),
              c = i.map(function(t) {
                return (n - o.b * (t.childElementCount - 1)) * h(t)[0];
              }),
              a = u(c, r);
            return (
              i.forEach(function(t, e) {
                ...
                !(function(t, e) {
                  ...
                  Array.from(t.children).forEach(function(t, e) {
                    var n = o[e];
                    t.setAttribute(
                      "style",
                      "height:".concat(n, "px;width:").concat(r, "px;")
                    );
                  });
                })(t, {
                  colHeight: n - o.b * (t.childElementCount - 1),
                  width: i,
                  rawWidth: r
                });
              }),
            ...
            rawHeight: d,
            rowWidth: n - o.b * (t.childElementCount - 1)
          });
        })(
          t,
          (function(t) {
      ...
      function a(t) {
        return Array.from(t.querySelectorAll(".tiled-gallery__row"));
      }
      function s(t) {
      ...
      function l(t) {
        var e = parseInt(t.dataset.width, 10),

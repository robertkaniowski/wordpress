!(function(e, t) {
  ...
  (function(e) {
    function t(t) {
      for (var n, r, a = t[0], i = t[1], l = 0, c = []; l < a.length; l++)
        (r = a[l]),
          ...
          t.push(
            (r[e] = new Promise(function(t, n) {
              for (
                var o =
                    "rtl" === document.dir
                      ? ({ 27: "vendors~map/mapbox-gl" }[e] || e) +
                        "." +
                        { 27: "58efaceccd1518ed2c94" }[e] +
                        ".rtl.css"
                      : ({ 27: "vendors~map/mapbox-gl" }[e] || e) +
                        "." +
                        { 27: "58efaceccd1518ed2c94" }[e] +
              ...
              for (c = 0; c < u.length; c++) {
                var p;
                if ((s = (p = u[c]).getAttribute("data-href")) === o || s === i)
                  return t();
              }
    ...
    102: function(e, t, n) {
      e.exports =
        n.p + "images/map-theme_default-2ceb449b599dbcbe2a90fead5a5f3824.jpg";
    },
    103: function(e, t, n) {
      e.exports =
        n.p +
        "images/map-theme_black_and_white-1ead5946ca104d83676d6e3410e1d733.jpg";
    },
    104: function(e, t, n) {
      e.exports =
        n.p + "images/map-theme_satellite-c74dc129bda9502fb0fb362bb627577e.jpg";
    },
    105: function(e, t, n) {
      e.exports =
        n.p + "images/map-theme_terrain-2b6e6c1c8d09cbdc58a4c0653be1a6e3.jpg";
    },
    106: function(e, t) {
      !(function() {
    ...
    109: function(e, t, n) {
            ...
            c()(t, [
              ...
              },
              {
                ...
                value: function() {
                  ...
                  this.marker
                    ? this.marker.setLngLat(i)
                    : ((l.className = "wp-block-jetpack-map-marker"),
                      (this.marker = new r.Marker(l)
                        .setLngLat(i)
                        .setOffset([0, -19])
                        .addTo(t)),
                      this.marker.getElement().addEventListener("click", a)),
                    (l.innerHTML =
          ...
          return (
            ...
            c()(t, [
              ...
              },
              {
                key: "componentDidUpdate",
                value: function(e) {
                  this.props.activeMarker !== e.activeMarker &&
      ...
      var _ = (function(e) {
        function t() {
          ...
          return (
            i()(this, t),
            (e = u()(this, f()(t).apply(this, arguments))),
            y()(m()(e), "onMarkerClick", function(t) {
              var n = e.props.onMarkerClick;
              e.setState({ activeMarker: t }), n();
            }),
            y()(m()(e), "onMapClick", function() {
              e.setState({ activeMarker: null });
            }),
            ...
            y()(m()(e), "setBoundsByMarkers", function() {
              ...
              if (
                c &&
                (a.length && n ? c.dragPan.disable() : c.dragPan.enable(),
                a.length && !s)
              ) {
                ...
                if (
                  ...
                  c.fitBounds(d, {
                    ...
                    e.setState({ boundsSetProgrammatically: !0 });
                  try {
                    c.removeControl(p);
                  } catch (m) {}
                } else {
                  ...
                  c.addControl(p),
                    e.setState({ boundsSetProgrammatically: !1 });
                }
              }
            }),
            y()(m()(e), "scriptsLoaded", function() {
              var t = e.props,
                n = t.mapCenter,
                r = t.points;
              e.setState({ loaded: !0 }), r.length, e.initMap(n);
            }),
            y()(m()(e), "googlePoint2Mapbox", function(e) {
              return e.hasOwnProperty("lat") && e.hasOwnProperty("lng")
                ? e
            ...
            (e.mapRef = Object(g.createRef)()),
            (e.debouncedSizeMap = Object(w.debounce)(e.sizeMap, 250)),
            e
          );
        }
        return (
          ...
          c()(t, [
              ...
              value: function() {
                var e = this,
                  ...
                  h = g.Children.map(o, function(e) {
                    if ("AddPoint" === Object(w.get)(e, "props.tagName"))
                      return e;
                  }),
                  v =
                    l &&
                    ...
                    n.map(function(e, t) {
                      return Object(
                        g.createElement
                      )(O, { key: t, point: e, index: t, map: l, mapboxgl: s, markerColor: a, onClick: u });
                    }),
                  y =
                    s &&
                    Object(g.createElement)(
                      C,
                      {
                        ...
                        mapboxgl: s,
                        unsetActiveMarker: function() {
                          return e.setState({ activeMarker: null });
                        }
                      },
                      c &&
                        r &&
                        Object(g.createElement)(
                          g.Fragment,
                          null,
                          Object(g.createElement)(j.TextControl, {
                          ...
                          Object(g.createElement)(
                            ...
                            " ",
                            Object(k.__)("Delete Marker", "jetpack")
                          )
                        ),
                      c &&
                        !r &&
                        Object(g.createElement)(
                          g.Fragment,
                          null,
                          Object(g.createElement)("h3", null, m),
                          Object(g.createElement)("p", null, b)
                        )
                    );
            ...
            },
            {
              ...
              value: function(e) {
                ...
                r && r.length > 0 && r !== e.apiKey && this.loadMapLibraries(),
                  o !== e.children && !1 !== o && this.clearCurrentMarker(),
                  a !== e.points && this.setBoundsByMarkers(),
                  a.length !== e.points.length && this.clearCurrentMarker(),
                  (i === e.mapStyle && l === e.mapDetails) ||
                    p.setStyle(this.getMapStyle()),
                  c !== e.scrollToZoom &&
                    (c ? p.scrollZoom.enable() : p.scrollZoom.disable()),
                  s !== e.showFullscreenButton &&
                    (s
                      ? (p.addControl(f),
                        n &&
                          f._fullscreenButton &&
                          (f._fullscreenButton.disabled = !0))
                      : p.removeControl(f));
              }
            },
            {
              ...
              value: function() {
                ...
                return (function(e, t) {
                  return {
                    default: {
                      details:
                        "mapbox://styles/automattic/cjolkhmez0qdd2ro82dwog1in",
                      no_details:
                        "mapbox://styles/automattic/cjolkci3905d82soef4zlmkdo"
                    },
                    black_and_white: {
                      details:
                        "mapbox://styles/automattic/cjolkixvv0ty42spgt2k4j434",
                      no_details:
                        "mapbox://styles/automattic/cjolkgc540tvj2spgzzoq37k4"
                    },
                    satellite: {
                    ...
                    terrain: {
                      details:
                        "mapbox://styles/automattic/cjolkf8p405fh2soet2rdt96b",
                      no_details:
                        "mapbox://styles/automattic/cjolke6fz12ys2rpbpvgl12ha"
                    }
            ...
            },
            {
              ...
              value: function() {
                var e = this,
                  t = this.props.apiKey;
                Promise.all([
                  n.e(27).then(n.t.bind(null, 431, 7)),
                  n.e(27).then(n.t.bind(null, 432, 7))
                ]).then(function(n) {
                  var r = o()(n, 1)[0].default;
                  (r.accessToken = t),
                    e.setState({ mapboxgl: r }, e.scriptsLoaded);
                });
              }
            },
            {
              ...
              value: function(e) {
                ...
                u.on("zoomend", function() {
                  ...
                  u.getCanvas().addEventListener("click", this.onMapClick),
                  this.setState(
                    { map: u, zoomControl: f, fullscreenControl: p },
                    function() {
                      t.debouncedSizeMap(),
                        u.addControl(f),
                        c &&
                          ...
                          s &&
                            p._fullscreenButton &&
                            (p._fullscreenButton.disabled = !0)),
                        t.mapRef.current.addEventListener(
                          "alignmentChanged",
                          t.debouncedSizeMap
                        ),
                        u.resize(),
    ...
    32: function(e, t, n) {
      ...
      var r = n(0),
        ...
        d = {
          ...
          category: "embed",
          keywords: [
            Object(o._x)("maps", "block search term", "jetpack"),
            Object(o._x)("location", "block search term", "jetpack"),
            Object(o._x)("navigation", "block search term", "jetpack")
          ],
          ...
          attributes: {
            ...
            mapDetails: { type: "boolean", default: !0 },
            zoom: { type: "integer", default: 13 },
            mapCenter: {
              type: "object",
              default: { longitude: -122.41941550000001, latitude: 37.7749295 }
            },
            markerColor: { type: "string", default: "red" },
            preview: { type: "boolean", default: !1 },
            scrollToZoom: { type: "boolean", default: !1 },
            mapHeight: { type: "integer" },
            showFullscreenButton: { type: "boolean", default: !0 }
          },
          supports: { defaultStylePicker: !1, html: !1 },
          styles: [
            {
              name: "default",
          ...
          markerIcon: Object(r.createElement)(
            "svg",
            {
              width: "14",
              height: "20",
            ...
            Object(r.createElement)(
              ...
              Object(r.createElement)(
                ...
                Object(r.createElement)("path", {
                  d:
                    "M12,2 C8.14,2 5,5.14 5,9 C5,14.25 12,22 12,22 C12,22 19,14.25 19,9 C19,5.14 15.86,2 12,2 Z M7,9 C7,6.24 9.24,4 12,4 C14.76,4 17,6.24 17,9 C17,11.88 14.12,16.19 12,18.88 C9.92,16.21 7,11.85 7,9 Z M13,6 L11,6 L11,8 L9,8 L9,10 L11,10 L11,12 L13,12 L13,10 L15,10 L15,8 L13,8 L13,6 Z",
                  id: "Shape",
                  fill: "#000",
                  fillRule: "nonzero"
                })
    ...
    38: function(e, t, n) {
      ...
      function i(e, t) {
        var n = (function(e, t) {
          ...
          try {
            for (
              var l, c = new o.a(t).values()[Symbol.iterator]();
              !(n = (l = c.next()).done);
              n = !0
            ) {
              var s = l.value;
                ...
                value: function(e) {
                  ...
                  try {
                    for (
                      ...
                      if (
                        "true" !==
                        y.getAttribute("data-jetpack-block-initialized")
                      ) {
                        ...
                        Object(h.render)(w, l ? y.querySelector(l) : y),
                          y.setAttribute("data-jetpack-block-initialized", !0);
                      }
                    }
                  } catch (j) {
                    (f = !0), (d = j);
              ...
              },
              {
                ...
                value: function(e, t) {
                  ...
                  for (var r in t) {
                    ...
                    if (
                      ((n[r] = e.getAttribute(a)),
                      "boolean" === o.type &&
                        (n[r] = "false" !== n[r] && !!n[r]),
                      "array" === o.type || "object" === o.type)
                    )
                      try {
                        n[r] = JSON.parse(n[r]);
                      } catch (i) {
              ...
              },
              {
                ...
                value: function(e) {
                  return u()(e.childNodes).map(function(e) {
                    ...
                    return (
                      (t.dangerouslySetInnerHTML = { __html: e.innerHTML }),

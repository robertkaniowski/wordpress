...
(function($) {
  ...
  if (tracksEvent.isAdmin) {
    ...
    trackAndBumpMCStats("non_admin_notice_view", {
      page: tracksEvent.currentScreen
    });
  }
  ...
  notice.on("click", ".notice-dismiss", function() {
    ...
    trackAndBumpMCStats("non_admin_notice_dismiss", {
      page: tracksEvent.currentScreen
    });
  });
  ...
  function confirmSafeMode() {
    ...
    $.ajax({
      ...
      success: function() {
        ...
        if (
          window.location.search &&
          1 === window.location.search.indexOf("page=jetpack")
        ) {
  ...
  function trackAndBumpMCStats(eventName, extraProps) {
    ...
    if (
      ...
      eventName =
        eventName.indexOf("jetpack_idc_") !== 0
          ? "jetpack_idc_" + eventName
          : eventName;

    ...
    generateMinimalHtml: function(e, s) {
      ...
      return (
        t.each(e, function(t, e) {
          ...
          e.classes.length > 0 && (r += " " + e.classes.join(" ")),
            (o +=
              '<p class="' +
              r +
              '" data-post-id="' +
            ...
            s.showDate &&
              (o +=
                '<span class="jp-relatedposts-post-date">' +
                e.date +
                "</span>"),
            s.showContext &&
              (o +=
    ...
    generateVisualHtml: function(e, s) {
      ...
      return (
        t.each(e, function(e, p) {
          ...
          if (
            (p.classes.length > 0 && (i += " " + p.classes.join(" ")),
            p.img.src
              ? (i += " jp-relatedposts-post-thumbs")
              : (i += " jp-relatedposts-post-nothumbs"),
            (o +=
              '<div class="' +
              i +
              '" data-post-id="' +
          ...
          (o +=
            ...
            (o +=
              ...
              "</p>"),
            s.showDate &&
              (o += '<p class="jp-relatedposts-post-date">' + p.date + "</p>"),
            s.showContext &&
              (o +=
          ...
          if (0 !== t.items.length && 0 !== o.length) {
            ...
            "undefined" != typeof wp && wp.customize
              ? ((p = wp.customize
                  ...
                  .get()),
                (r.showDate = wp.customize
                  .instance("jetpack_relatedposts[show_date]")
                  .get()),
                (r.showContext = wp.customize
                  .instance("jetpack_relatedposts[show_context]")
                  .get()),
                (r.layout = wp.customize
                  .instance("jetpack_relatedposts[layout]")
                  .get()))
              : ((p = t.show_thumbnails),
                (r.showDate = t.show_date),
                (r.showContext = t.show_context),
                (r.layout = t.layout)),
              (a = p
                ? e.generateVisualHtml(t.items, r)
                : e.generateMinimalHtml(t.items, r)),
              o.append(a),
              r.showDate && o.find(".jp-relatedposts-post-date").show(),
              o.show(),
              s();
          }
        });

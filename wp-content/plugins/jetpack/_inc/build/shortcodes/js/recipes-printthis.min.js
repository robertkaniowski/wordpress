...
!(function(e) {
  ...
  (e.fn.printThis = function(n) {
    ...
    if (
      ...
      e("<iframe id='" + a + "' name='printIframe' />").appendTo("body");
    }
    var d = e("#" + a);
    t.debug ||
      d.css({
      ...
      setTimeout(function() {
        ...
        if (
          ...
          t.pageTitle && o.append("<title>" + t.pageTitle + "</title>"),
          t.loadCSS &&
            (e.isArray(t.loadCSS)
        ...
        if (
          ...
          p.length &&
            p.each(function() {
              var t = e(this),
                n = e(this).attr("name"),
                i = t.is(":checkbox") || t.is(":radio"),
                o = a.find('input[name="' + n + '"]'),
                r = t.val();
              i
                ? t.is(":checked") &&
                  (t.is(":checkbox")
          ...
          h.length &&
            h.each(function() {
              var t = e(this),
                n = e(this).attr("name"),
                i = t.val();
              a.find('select[name="' + n + '"]').val(i);
            });
          var l = i.find("textarea");
          l.length &&
            l.each(function() {
              var t = e(this),
                n = e(this).attr("name"),
                i = t.val();
              a.find('textarea[name="' + n + '"]').val(i);
            });
        }
        t.removeInline &&
          (e.isFunction(e.removeAttr)
            ? a.find("body *").removeAttr("style")
            : a.find("body *").attr("style", "")),
          t.footer && r.append(t.footer),
          setTimeout(function() {
            d.hasClass("MSIE")
              ? (window.frames.printIframe.focus(),
                o.append("<script>  window.print(); </script>"))
              : document.queryCommandSupported("print")
              ? d[0].contentWindow.document.execCommand("print", !1, null)

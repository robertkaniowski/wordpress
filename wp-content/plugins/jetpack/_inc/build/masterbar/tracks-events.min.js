...
!(function(a) {
  var e = {
      ...
      "wp-admin-bar-reader-followed-sites-manage":
        "reader_manage_followed_sites",
  ...
  a(document).ready(function() {
    a(
      ".mb-trackable .ab-item:not(div),#wp-admin-bar-notes .ab-item,#wp-admin-bar-user-info .ab-item,.mb-trackable .ab-secondary"
      ...
      if (
        ...
        var t = a(i.target),
          n = t.closest("li");
        if ((t.is("a") || (t = t.closest("a")), n && t)) {
          var s = t.attr("ID") || n.attr("ID");
          if (e.hasOwnProperty(s)) {
            ...
            n.hasClass("menupop")
              ...
              : (i.preventDefault(),
                window.jpTracksAJAX
                  .record_ajax_event("masterbar_click", "click", r)
                  .always(function() {
    ...
    a(window).on("message", function(a) {
      if (
        ...
        var e = !a.data && a.originalEvent.data ? a.originalEvent : a;
        if ("https://widgets.wp.com" === e.origin) {
          var t =

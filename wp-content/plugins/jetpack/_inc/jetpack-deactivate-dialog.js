...
(function($) {
  ...
  window.deactivationModalTrackCloseEvent = function() {
    analytics.tracks.recordEvent(
      "jetpack_termination_dialog_close_click",
      tracksProps
    );
    document.onkeyup = "";
  };
  ...
  deactivateLinkElem.on("click", function(e) {
    ...
    analytics.tracks.recordEvent(
      "jetpack_termination_dialog_open",
      tracksProps
    );
  });
  ...
  $("#jetpack_deactivation_dialog_content__button-deactivate").on(
    "click",
    function(e) {
      e.preventDefault();
      ...
      analytics.tracks.recordEvent(
        "jetpack_termination_dialog_termination_click",
        tracksProps
      );
      deactivateJetpack();
    }

  ...
  function(t, e) {
    var n = function() {
      var t,
        ...
        n,
        o,
        r = { rootMargin: "200px 0px", threshold: 0.01 },
        i = 0;
      c();
      ...
      function c() {
        if (
          ...
          for (e = new IntersectionObserver(a, r), o = 0; o < t.length; o++)
            (n = t[o]).getAttribute("data-lazy-loaded") || e.observe(n);
        else
          !(function(t) {
            var e;
      ...
      function h(t) {
        ...
        if (!(!t instanceof HTMLImageElement)) {
          (e = t.getAttribute("data-lazy-srcset")),
            (n = t.getAttribute("data-lazy-sizes")),
            ...
            n && t.setAttribute("sizes", n),
            e ? t.setAttribute("srcset", e) : t.removeAttribute("srcset");
          try {
      ...
      s &&
        (s.addEventListener("is.post-load", c),
        s.addEventListener("jetpack-lazy-images-load", c));
    };
    !(function(t, e) {
      "use strict";
      if (
        ...
        (r.prototype.THROTTLE_TIMEOUT = 100),
          ...
          (r.prototype._checkForIntersections = function() {
            ...
            this._observationTargets.forEach(function(r) {
              ...
              h
                ? e && a
                  ? this._hasCrossedThreshold(h, l) &&
                    this._queuedEntries.push(l)
                  : h && h.isIntersecting && this._queuedEntries.push(l)
                : this._queuedEntries.push(l);
            }, this),
          ...
          (r.prototype._computeTargetAndRootIntersection = function(n, o) {
            if ("none" != t.getComputedStyle(n).display) {
              for (
                var r, i, s, a, u, l, d, p, f = c(n), g = h(n), v = !1;
                !v;

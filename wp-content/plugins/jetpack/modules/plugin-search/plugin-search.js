  ...
  JetpackPSH = {
    ...
    moveActionLinks: function() {
      ...
      if ("object" === typeof hint && null !== hint) {
        ...
        var descriptionText = descriptionContainer.querySelector(
          "p:first-child"
        );
        ...
        descriptionContainer.innerHTML =
          descriptionText.outerHTML + actionLinks.outerHTML;
    ...
    replaceCardBottom: function() {
      ...
      if ("object" === typeof hint && null !== hint) {
        ...
        var dismissLink = document.querySelector(
          ".jetpack-plugin-search__dismiss"
        );
    ...
    replaceOnNewResults: function(mutationsList) {
      mutationsList.forEach(function(mutation) {
        if (
          ...
          1 ===
            document.querySelectorAll(".plugin-card-jetpack-plugin-search")
              .length
        ) {
    ...
    updateButton: function(moduleName) {
      $.ajax({
        ...
        var $moduleBtn = JetpackPSH.$pluginFilter.find(
          "#plugin-select-activate"
        );
        ...
        setTimeout(function() {
          var url =
              "https://jetpack.com/redirect/?source=plugin-hint-learn-" +
              moduleName,
          ...
          if (response.options && 0 < Object.keys(response.options).length) {
            ...
            var learnMore = document.querySelector(
              ".jetpack-plugin-search__learn-more"
            );
    ...
    init: function() {
      ...
      var resultsObserver = new MutationObserver(
        JetpackPSH.replaceOnNewResults
      );

...
jQuery(function($) {
  if (typeof jetpack_empty_spam_button_parameters !== "undefined") {
    ...
    var jetpack_empty_spam_feedbacks_button = $("<a />")
      ...
      .attr(
        "data-progress-label",
        jetpack_empty_spam_button_parameters.progress_label
      )
      .attr(
        "data-success-url",
        jetpack_empty_spam_button_parameters.success_url
      )
      .attr(
        "data-failure-url",
        jetpack_empty_spam_button_parameters.failure_url
      )
      .attr(
        "data-spam-feedbacks-count",
        jetpack_empty_spam_button_parameters.spam_count
      )
      .attr("data-nonce", jetpack_empty_spam_button_parameters.nonce)
      .text(jetpack_empty_spam_button_parameters.label);
    jetpack_empty_spam_feedbacks_button_container.append(
      jetpack_empty_spam_feedbacks_button
    );
    ...
    jetpack_empty_spam_feedbacks_button_container.append(
      jetpack_empty_spam_feedbacks_spinner
    );
  ...
  $(document).on(
    "click",
    "#jetpack-check-feedback-spam:not(.button-disabled)",
    function(e) {
      e.preventDefault();

      $("#jetpack-check-feedback-spam:not(.button-disabled)").addClass(
        "button-disabled"
      );

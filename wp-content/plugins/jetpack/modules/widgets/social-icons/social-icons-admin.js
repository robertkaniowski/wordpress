  ...
  $(document).ready(function() {
    ...
    $(document).on(
      ...
      function(event) {
        ...
        template = $(
          $.trim($("#tmpl-jetpack-widget-social-icons-template").html())
        );
        ...
        widgetLastItem = widgetContent.find(
          ".jetpack-social-icons-widget-item:last"
        );
    ...
    $(document).on(
      ...
      function() {
        ...
        initWidget(
          $(this).parents('.widget[id*="jetpack_widget_social_icons"]')
        );
      }
    );
    ...
    $(document).on(
      "focusout",
      'input[name*="jetpack_widget_social_icons"]',
      function() {
        livePreviewUpdate(
          $(this)
            .parents(".form")
    ...
    $(document).on(
      "change",
      'select[name*="jetpack_widget_social_icons"]',
      function() {
        livePreviewUpdate(
          $(this)
            .parents(".form")

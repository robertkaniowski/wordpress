...
(function($) {
  ...
  $(function() {
    $(document.body).on("click", ".gallery-widget-choose-images", function(
      event
    ) {
  ...
  l10n = media.view.l10n =
    typeof _wpMediaViewsL10n === "undefined" ? {} : _wpMediaViewsL10n;
  ...
  function setupThumbs(selection, wrapper) {
    ...
    selection.each(function(model) {
      var sizedUrl =
        model.get("url") + "?w=" + imageSize + "&h=" + imageSize + "&crop=true";
  ...
  function getAttachments(idsString) {
    ...
    var shortcode = wp.shortcode.next(
      "gallery",
      '[gallery ids="' + idsString + '"]'
    );

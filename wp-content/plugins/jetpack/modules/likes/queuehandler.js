...
function jetpackLoadLikeWidgetIframe(wrapperID) {
  ...
  if (placeholder.hasClass("comment-likes-widget-placeholder")) {
    ...
    commentLikesFrame["class"] =
      "comment-likes-widget-frame jetpack-likes-widget-frame";
...
function jetpackIsScrolledIntoView(element) {
  ...
  return (
    top + jetpackLikesLookAhead >= 0 &&
    bottom <= window.innerHeight + jetpackLikesLookAhead
  );
}
...
var jetpackOnScrollStopped = jetpackWidgetsDelayedExec(
  250,

    ...
    paypal.Button.render(
      {
        ...
        payment: function() {
          ...
          var payload = {
            number: PaypalExpressCheckout.getNumberOfItems(
              domId + "_number",
              enableMultiple
            ),
            buttonId: buttonId,
          ...
          return new paypal.Promise(function(resolve, reject) {
            jQuery
              .post(
                PaypalExpressCheckout.getCreatePaymentEndpoint(blogId),
                payload
              )
              ...
              .fail(function(paymentError) {
                var paymentErrorMessage = PaypalExpressCheckout.processErrorMessage(
                  paymentError
                );
        ...
        onAuthorize: function(onAuthData) {
          ...
          return new paypal.Promise(function(resolve, reject) {
            jQuery
              .post(
                PaypalExpressCheckout.getExecutePaymentEndpoint(
                  blogId,
                  onAuthData.paymentID
                ),
                payload
              )
              ...
              .fail(function(authError) {
                var authErrorMessage = PaypalExpressCheckout.processErrorMessage(
                  authError
                );

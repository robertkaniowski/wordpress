...
(function(wp) {
  var VideoPress = {
    ...
    resetToOriginalOptions: function(up) {
      ...
      if (typeof VideoPress.originalOptions.multipart_params !== "undefined") {
        up.setOption(
          "multipart_params",
          VideoPress.originalOptions.multipart_params
        );
      ...
      if (typeof VideoPress.originalOptions.file_data_name !== "undefined") {
        up.setOption(
          "file_data_name",
          VideoPress.originalOptions.file_data_name
        );
  ...
  if (typeof wp.Uploader !== "undefined") {
     ...
     */
    plupload.addFileFilter("videopress_check_uploads", function(
      maxSize,
      file,
      cb
    ) {
      ...
      if (mimeParts[0] === "video") {
        media
          .ajax("videopress-get-upload-token", {
            async: false,

...
jQuery(function($) {
  ...
  function setWidgetMargin($widget) {
    ...
    if ($widget.hasClass("expanded")) {
      ...
      $widget
        .attr("style", $widget.data("original-style"))
  ...
  function moveWidgetVisibilityButton($widget) {
    ...
    $displayOptionsButton.insertBefore(
      $widget.find("input.widget-control-save")
    );
  ...
  $(document).on("widget-added", function(e, $widget) {
    if (
      $widget.find("div.widget-control-actions a.display-options").length === 0
    ) {
  ...
  widgets_shell.on("click.widgetconditions", "a.display-options", function(e) {
    ...
    $widget
      .find("div.widget-conditional")
      .toggleClass("widget-conditional-hide");
  ...
  widgets_shell.on(
    "change.widgetconditions",
    "input.conditions-match-all",
    function() {
      $(this)
  ...
  $(document).on(
    "change.widgetconditions",
    "select.conditions-rule-major",
    function() {
      var $conditionsRuleMajor = $(this),
        $conditionsRuleMinor = $conditionsRuleMajor.siblings(
          "select.conditions-rule-minor:first"
        ),
      ...
      $condition
        .data("rule-minor", "")
        .data("rule-major", $conditionsRuleMajor.val());
  ...
  $(document).on(
    "change.widgetconditions",
    "select.conditions-rule-minor",
    function() {
      var $conditionsRuleMinor = $(this),
        $conditionsRuleMajor = $conditionsRuleMinor.siblings(
          "select.conditions-rule-major"
        ),

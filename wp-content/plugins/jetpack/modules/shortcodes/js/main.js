(function($) {
  ...
  function Presentation(wrapper) {
    ...
    _self.autoplayTime =
      parseFloat(_self.slideshow.attr("data-autoplay"), 10) || 0;
  ...
  $.extend(Presentation.prototype, {
    resizePresentation: function() {
      ...
      if (this.fullscreen) {
        ...
        new_css.top =
          ($(window).height() - scale * this.slideshow.height()) / 2;
      ...
      if (
        this.slideshow.css("-moz-transform") ||
        this.slideshow.css("-ms-transform")
      ) {
    ...
    setAutoplay: function(on) {
      ...
      _self.slideshow.jmpress(
        "settings"
      ).duration.defaultValue = newAutoplayTime;

(function(localized) {
    ...
    xhrRequest.onload = function() {
      if (this.status == 200) {
        ...
        if (body && body.data) {
          ...
          var numberOfThreats =
            apiResponse.threats && apiResponse.threats.length
              ? apiResponse.threats.length
              : 0;
  ...
  function update_threats_link(numberOfThreats) {
    ...
    var textLabel =
      numberOfThreats == 1 ? localized.singular : localized.multiple;
    element.innerHTML =
      '<a href="' +
      localized.scan_dashboard_url +
      '" class="ab-item">' +
      textLabel +
      "</a>";
  }

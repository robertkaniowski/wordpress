...
jQuery(function($) {
  ...
  $(".save-preprocessor").bind("click", function(e) {
    ...
    $("#preprocessor-display").text(
      $("#preprocessor_choices option:selected").text()
    );
  ...
  $(".cancel-css-mode").bind("click", function(e) {
    ...
    $("#css-mode-select").slideUp(function() {
      $(".edit-css-mode").show();
      $(
        "input[name=add_to_existing_display][value=" +
          $("#add_to_existing").val() +
          "]"
      ).attr("checked", true);
    });
  ...
  $(".save-css-mode").bind("click", function(e) {
    ...
    $("#css-mode-display").text(
      $("input[name=add_to_existing_display]:checked").val() === "true"
        ? "Add-on"
        : "Replacement"
    );
    $("#add_to_existing").val(
      $("input[name=add_to_existing_display]:checked").val()
    );
    $(".edit-css-mode").show();
  });
});

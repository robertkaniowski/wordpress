...
(window.CodeMirror = (function() {
  ...
  function x(a, c) {
    ...
    this.options = c = c || {};
    for (var d in _c)
      !c.hasOwnProperty(d) && _c.hasOwnProperty(d) && (c[d] = _c[d]);
    J(c);
  ...
  function K(a) {
    ...
    (b.sizer.style.minHeight = b.heightForcer.style.top = d + "px"),
      (b.gutters.style.height =
        Math.max(d, b.scroller.clientHeight - Ve) + "px");
    ...
    g
      ...
      f
        ? ((b.scrollbarH.style.display = "block"),
          ...
          (b.scrollbarH.firstChild.style.width =
            b.scroller.scrollWidth -
            b.scroller.clientWidth +
            b.scrollbarH.clientWidth +
            "px"))
      ...
      l &&
        0 === tf(b.measure) &&
        ((b.scrollbarV.style.minWidth = b.scrollbarH.style.minHeight = m
          ? "18px"
          : "12px"),
        (b.scrollbarV.style.pointerEvents = b.scrollbarH.style.pointerEvents =
          "none"));
  }
  function L(a, b, c) {
  ...
  function R(a, b, c, d) {
    ...
    if (!e.wrapper.clientWidth)
      return (
        (e.showingFrom = e.showingTo = f.first), (e.viewOffset = 0), void 0
      );
    if (
      !(!d && 0 == b.length && c.from > e.showingFrom && c.to < e.showingTo)
    ) {
      ...
      if (
        (e.showingFrom < k &&
          k - e.showingFrom < 20 &&
          (k = Math.max(f.first, e.showingFrom)),
        e.showingTo > l &&
          e.showingTo - l < 20 &&
          (l = Math.min(j, e.showingTo)),
        w)
      )
        for (k = pe(Fd(f, le(f, k))); j > l && Gd(f, le(f, l)); ) ++l;
      var m = [
        { from: Math.max(e.showingFrom, f.first), to: Math.min(e.showingTo, j) }
      ];
        ...
        if ((2 > f && (f = Ab(b)), i > 0.001 || -0.001 > i)) {
          ...
          if (j)
            for (var k = 0; k < j.length; ++k)
              j[k].height = j[k].node.offsetHeight;
        }
      }
  }
  function T(a) {
          ...
          if ((0 != b.height && oe(b, 0), b.widgets && k && k.previousSibling))
            for (var c = 0; c < b.widgets.length; ++c) {
              ...
              if (f.showIfHidden) {
                ...
                var p = h.appendChild(
                  lf("div", [f.node], "CodeMirror-linewidget")
                );
  ...
  function X(a, b, d, e, f) {
    ...
    if (!(a.options.lineNumbers || i || l || b.wrapClass || b.widgets))
      return h;
    if (f) {
      f.alignable = null;
      for (var q, m = !0, n = 0, o = null, p = f.firstChild; p; p = q)
        if (
          ((q = p.nextSibling), /\bCodeMirror-linewidget\b/.test(p.className))
        ) {
    ...
    if (
      ...
      l &&
        k.insertBefore(
          lf("div", null, l + " CodeMirror-linebackground"),
          k.firstChild
        ),
      ...
      return (
        Af(se(i), d || 0, null == e ? j : e, function(a, b, c) {
          ...
          null == d && 0 == a && (o = g),
            ...
            null == e && b == j && (p = f),
            (!k || i.top < k.top || (i.top == k.top && i.left < k.left)) &&
              (k = i),
            (!l ||
              n.bottom > l.bottom ||
  ...
  function cb(a) {
    ...
    if (
      ...
      !(b.frontier >= a.display.showingTo))
    ) {
      var f,
      ...
      b.iter(
        b.frontier,
        Math.min(b.first + b.size, a.display.showingTo + 500),
        function(g) {
          if (b.frontier >= a.display.showingFrom) {
            var h = g.styles;
            g.styles = Sd(a, g, d);
            for (
              var i = !h || h.length != g.styles.length, j = 0;
              !i && j < h.length;
              ++j
            )
              i = h[j] != g.styles[j];
            ...
            Ud(a, g, d),
              (g.stateAfter = 0 == b.frontier % 5 ? hd(b.mode, d) : null);
          return (
            ++b.frontier,
            +new Date() > c ? (bb(a, a.options.workDelay), !0) : void 0
          );
        }
      ),
        e.length &&
  ...
  function eb(a, b, c) {
    ...
    return (
      ...
      d.iter(f, b, function(c) {
        Ud(a, c, g);
        var h =
          f == b - 1 || 0 == f % 5 || (f >= e.showingFrom && f < e.showingTo);
  ...
  function hb(a) {
    var b = nf(
      a.measure,
      lf("pre", null, null, "text-align: left")
    ).appendChild(lf("span", "x"));
    return b.offsetLeft;
  }
  ...
  function lb(a, b) {
    ...
    return (
      16 == e.length
        ? (e[++a.display.measureLineCachePos % 16] = f)
        : e.push(f),
      d
    );
  }
  function mb(a, e) {
    ...
    if (
      !a.options.lineWrapping &&
      e.text.length >= a.options.crudeMeasuringFrom
    )
      return nb(a, e);
    var f = a.display,
      g = ef(e.text.length),
    ...
    if (b && !c && !a.options.lineWrapping && h.childNodes.length > 100) {
      for (
        ...
        for (
          var n = lf("div", null, null, "display: inline-block"), o = 0;
          j > o && k;
          ++o
        )
    ...
    for (var v, l = 0; l < r.length; ++l)
      (v = r[l]) &&
        (u(v), v.leftSide && u(v.leftSide), v.rightSide && u(v.rightSide));
    return r;
  }
  function nb(a, b) {
  ...
  function Eb(a) {
    ...
    if (
      ...
      var f = Math.max(
        0,
        d.sizer.offsetLeft + d.sizer.offsetWidth - d.scroller.clientWidth
      );
      f < c.scrollLeft &&
        !b.updateScrollPos &&
        ac(a, Math.min(d.scroller.scrollLeft, f), !0);
    }
    var g, h;
    ...
    (b.changes.length || b.forceUpdate || (g && null != g.scrollTop)) &&
      ...
      b.updateScrollPos
        ? ((d.scroller.scrollTop = d.scrollbarV.scrollTop = c.scrollTop =
            g.scrollTop),
          (d.scroller.scrollLeft = d.scrollbarH.scrollLeft = c.scrollLeft =
            g.scrollLeft),
          M(a),
          b.scrollToPos &&
            Pc(
    ...
    if (j)
      for (var l = 0; l < j.length; ++l) j[l].lines.length || Ne(j[l], "hide");
    if (k)
      for (var l = 0; l < k.length; ++l)
        k[l].lines.length && Ne(k[l], "unhide");
    var m;
    if (
      (--Pe || ((m = Oe), (Oe = null)),
  ...
  function Lb(a) {
    ...
    j < e.length
      ...
      : a.state.overwrite &&
        ...
        (m = Bc(
          m.line,
          Math.min(le(f, m.line).text.length, m.ch + (h.length - j))
        ));
  ...
  function Mb(a, c) {
    ...
    if (Cc(g.sel.from, g.sel.to))
      ...
      (a.display.prevInput = ""),
        (e =
          yf &&
          (g.sel.to.line - g.sel.from.line > 100 ||
  ...
  function Pb(a) {
    ...
    function j(b) {
      Re(a, b) ||
        (a.options.onDragEvent && a.options.onDragEvent(a, Ee(b))) ||
        Ie(b);
    }
    function l() {
  ...
  function Wb(a, b) {
    return Te(a, "gutterContextMenu")
      ? Vb(a, b, "gutterContextMenu", !1, Ne)
      : !1;
  }
  function Xb(a, b) {
  ...
  function $b(a, c) {
    ...
    if (!Re(a, c) && !Qb(a.display, c)) {
      ...
      if (
        (c.dataTransfer.setData("Text", d), c.dataTransfer.setDragImage && !j)
      ) {
  ...
  function dc(b, c) {
    ...
    if (
        ...
        return (
          e &&
            _b(
              ...
              Math.max(
                0,
                Math.min(h.scrollTop + e * cc, h.scrollHeight - h.clientHeight)
              )
            ),
          ac(
            b,
            Math.max(
              0,
              Math.min(h.scrollLeft + d * cc, h.scrollWidth - h.clientWidth)
            )
          ),
          Fe(c),
          (g.wheelStartX = null),
      ...
      if (e && null != cc) {
        ...
        0 > k
          ? (l = Math.max(0, l + k - 50))
          : (m = Math.min(b.doc.height, m + k + 50)),
          Q(b, [], { top: l, bottom: m });
      }
      20 > bc &&
        (null == g.wheelStartX
    ...
    if (
      ...
      if (!((i && (!a.which || a.which < 10)) || k) || !hc(c, a)) {
        ...
        this.options.electricChars &&
          ...
          ic(c, a, g) ||
            (b && !d && (c.display.inputHasSelection = null), Kb(c));
      }
    }
  }
  function mc(a) {
    ...
    if (!a.cm || !a.cm.state.suppressEdits) {
      ...
      if (d) {
        ...
        for (
          ...
          var i = g
            ? sc(a, h, null)
            : { anchor: d.anchorBefore, head: d.headBefore };
          yc(a, h, i, Ad(a, h));
          var j = [];
          je(a, function(a, b) {
            b ||
              -1 != bf(j, a.history) ||
              (Ce(a.history, h), j.push(a.history)),
              yc(a, h, null, Ad(a, h));
          });
        }
      }
  ...
  function zc(a, b, c, d) {
    ...
    a.options.lineWrapping ||
      ...
      Dc(e.sel.head, b.from) ||
        Dc(b.to, e.sel.head) ||
        (a.curOp.cursorActivity = !0),
      ce(e, b, c, d, B(a)),
      a.options.lineWrapping ||
  ...
  function Ac(a, b, c, d, e) {
    ...
    "string" == typeof b && (b = wf(b)),
      uc(a, { from: c, to: d, text: b, origin: e }, null);
  }
  function Bc(a, b) {
  ...
  function Gc(a, b) {
    ...
    return b.line > c
      ? Bc(c, le(a, c).text.length)
      : Hc(b, le(a, b.line).text.length);
  }
  function Hc(a, b) {
    var c = a.ch;
          ...
          if (
            ...
            if (
              ...
              l.ch < 0
                ...
                : l.ch > h.text.length &&
                  (l =
                    l.line < a.first + a.size - 1 ? Bc(l.line + 1, 0) : null),
              !l)
            ) {
              if (e)
                return d
                  ? ((a.cantEdit = !0), Bc(a.first, 0))
                  : Nc(a, b, c, !0);
              (e = !0), (l = b), (g = -g);
            }
            f = l;
  ...
  function Qc(a, b, c, d, e) {
    var f = Rc(a, b, c, d, e);
    null != f.scrollTop && _b(a, f.scrollTop),
      null != f.scrollLeft && ac(a, f.scrollLeft);
  }
  ...
  function Tc(a, b, c) {
    ...
    (d.scrollTop = Math.max(
      0,
      Math.min(e.scrollHeight - e.clientHeight, d.scrollTop + c)
    )),
      (d.scrollLeft = Math.max(
        0,
        Math.min(e.scrollWidth - e.clientWidth, d.scrollLeft + b)
      ));
  }
  function Uc(a, b, c, d) {
    var e = a.doc;
  ...
  function yd(a, b, c) {
    if (a)
      for (var e, d = 0; d < a.length; ++d) {
        ...
        if (
          h ||
          ("bookmark" == g.type && f.from == b && (!c || f.marker.insertLeft))
        ) {
          var i =
    ...
    return null != a.height
      ...
      : ((a.node.parentNode && 1 == a.node.parentNode.nodeType) ||
          nf(
            ...
            lf("div", [a.node], null, "position: relative")
          ),
  ...
  function Xd(a, c, d, g) {
    ...
    !d ||
      k.measuredSomething ||
      d[0] ||
      (d[0] = k.pre.appendChild(
        j ? lf("span", "\xa0") : vf(a.display.measure)
      )),
      k.pre.firstChild ||
        Gd(a.doc, c) ||
        k.pre.appendChild(document.createTextNode("\xa0"));
    var m;
    if (d && (b || e) && (m = se(i))) {
      var n = m.length - 1;
      m[n].from == m[n].to && --n;
      ...
      if (o.from + 1 == o.to && p && o.level < p.level) {
        ...
        q &&
          q.parentNode.insertBefore(
            (q.measureRight = vf(a.display.measure)),
            q.nextSibling
          );
      }
    }
    ...
    if (b) {
      if (Yd.test(b))
        for (var g = document.createDocumentFragment(), h = 0; ; ) {
          ...
          if (
            (j &&
              (g.appendChild(document.createTextNode(b.slice(h, h + j))),
              (a.col += j)),
            !i)
          )
            break;
  ...
  function ae(a, b, c, d) {
    ...
    if (
      e &&
      (a.copyWidgets && (e = e.cloneNode(!0)), a.pre.appendChild(e), a.measure)
    ) {
  ...
  function pe(a) {
    ...
    for (
      var b = a.parent, c = bf(b.lines, a), d = b.parent;
      d;
      b = d, d = d.parent
    )
  ...
  function we(a, b, c, d) {
    ...
    if (
      ...
      var h = _e(g.changes);
      Cc(b.from, b.to) && Cc(b.from, h.to)
        ? (h.to = qc(b))
        : g.changes.push(ve(a, b)),
  ...
  function Be(a, b, c, d) {
    for (var e = 0; e < a.length; ++e) {
      for (var f = a[e], g = !0, h = 0; h < f.changes.length; ++h) {
        var i = f.changes[h];
        if (
          (f.copied || ((i.from = Ec(i.from)), (i.to = Ec(i.to))),
          c < i.from.line)
        )
  ...
  function hf(a) {
    return (
      /\w/.test(a) ||
      (a > "\x80" && (a.toUpperCase() != a.toLowerCase() || gf.test(a)))
    );
  }
  function jf(a) {
  ...
  function tf(a) {
    ...
    return (
      nf(a, b), b.offsetWidth && (sf = b.offsetHeight - b.clientHeight), sf || 0
    );
  }
  function vf(a) {
    if (null == uf) {
  ...
  function Lf(a, b, c, d) {
    ...
    for (
      var f = Jf(e, b), g = e[f], h = Kf(a, b, g.level % 2 ? -c : c, d);
      ;
  ...
  (x.Pos = Bc),
    (x.prototype = {
      ...
      indentSelection: Fb(null, function(a) {
        ...
        for (
          var c = b.to.line - (b.to.ch ? 0 : 1), d = b.from.line;
          c >= d;
          ++d
        )
          Uc(this, d, a);
      ...
      getHelper: function(a, b) {
        if (gd.hasOwnProperty(b)) {
          var c = gd[b],
            d = this.getModeAt(a);
          return (
            (d[b] && c[d[b]]) || (d.helperType && c[d.helperType]) || c[d.name]
          );
        }
      },
      getStateAfter: function(a, b) {
        var c = this.doc;
        return (
          (a = Fc(c, null == a ? c.first + c.size - 1 : a)), eb(this, a + 1, b)
        );
      },
      ...
      heightAtLine: function(a, b) {
        ...
        var e = le(this.doc, a);
        return (
          sb(this, le(this.doc, a), { top: 0, left: 0 }, b || "page").top +
          (c ? e.height : 0)
        );
      },
  ...
  (kd.basic = {
    ...
    (qd.prototype.find = function() {
      for (var a, b, c = 0; c < this.lines.length; ++c) {
        ...
        if (null != e.from || null != e.to) {
          var f = pe(d);
          null != e.from && (a = Bc(f, e.from)),
            null != e.to && (b = Bc(f, e.to));
        }
      }
    ...
    (qd.prototype.changed = function() {
      ...
      if (a && b) {
        ...
        if (
          (kb(b, c),
          a.line >= b.display.showingFrom && a.line < b.display.showingTo)
        ) {
  ...
  (ge.prototype = cf(ee.prototype, {
    ...
    replaceSelection: function(a, b, c) {
      uc(
        this,
        { from: this.sel.from, to: this.sel.to, text: wf(a), origin: c },
        b || "around"
      );
    },
    undo: Gb(function() {
    ...
    copy: function(a) {
      var b = new ge(
        ne(this, this.first, this.first + this.size),
        this.modeOption,
        this.first
      );
      return (
    ...
    Nf = (function() {
      ...
      return function(a) {
        ...
        return (
          ...
          t[0].level != _e(t).level &&
            t.push({ from: b, to: b, level: t[0].level }),
          t
        );
      };
    })();
  ...
  CodeMirror.defineMode("css", function(a, b) {
    ...
    function n(a, b) {
      return function(c, d) {
        for (var f, e = !1; null != (f = c.next()) && (f != a || e); )
          e = !e && "\\" == f;
    ...
    return {
      ...
      token: function(a, b) {
        if (((b.tokenize = b.tokenize || m), b.tokenize == m && a.eatSpace()))
          return null;
        ...
        if ("property" == c) {
          ...
          "atom" == c
            ? d && "@media{" != d && "block" != d
              ? "propertyValue" == d
                ? /^#([0-9a-fA-f]{3}|[0-9a-fA-f]{6})$/.test(a.current()) ||
                  (c += " error")
                : (c = "error")
              : (c = "builtin")
            : "@media" == d && "{" == k && (c = "error");
        if ("{" == k)
          if ("@media" == d || "@mediaType" == d)
    ...
    CodeMirror.defineMIME("text/css", {
      ...
      CodeMirror.defineMIME("text/x-scss", {
        ...
        hooks: {
          ...
          ",": function(a, b) {
            return "propertyValue" == b.stack[b.stack.length - 1]
              ? ["operator", ";"]
              : void 0;
          },
          "/": function(a, b) {
  ...
  CodeMirror.defineMode("less", function(a) {
      ...
      if ("=" == f) d(null, "compare");
        ...
        if ("/" == f) {
          ...
          if (/[;{}:\[\]()~\|]/.test(f)) {
            ...
            if (
              (a.eatWhile(/[\w\\\-_%.{]/), null === a.current().match(/\\/))
            ) {
              if ("string" == c)
              ...
              if (
                /\/|[\s\)]/.test(
                  a.peek() || a.eol() || (a.eatSpace() && "/" == a.peek())
                ) &&
                -1 !== a.current().indexOf(".")
              )
                return "{" ==
                  a
                    .current()
                    .substring(a.current().length - 1, a.current().length)
    ...
    function j(a) {
      return function(b, c) {
        for (var g, e = !1; null != (g = b.next()) && (g != a || e); )
          e = !e && "\\" == g;
  ...
  CodeMirror.mimeModes.hasOwnProperty("text/css") ||

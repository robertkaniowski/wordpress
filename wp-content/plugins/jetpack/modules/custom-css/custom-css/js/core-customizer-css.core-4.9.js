  ...
  $(document).ready(function() {
    ...
    if (cssModeControl) {
      cssModeControl.prepend(
        '<span class="customize-control-title">' +
          window._jp_css_settings.l10n.mode +
          "</span>"
      );
    }
    ...
    if (mobileCssControl) {
      mobileCssControl.prepend(
        '<span class="customize-control-title">' +
          window._jp_css_settings.l10n.mobile +
          "</span>"
      );
    }
    ...
    if (widthControl) {
      widthControl.append(
        '<span class="description">' +
          window._jp_css_settings.l10n.contentWidth +
          "<span>"
      );
    ...
    customize("jetpack_custom_css[preprocessor]", function(
      preprocessorSetting
    ) {

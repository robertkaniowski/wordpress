    ...
    get_counts: function() {
      ...
      for (url in WPCOM_sharing_counts) {
        ...
        for (service in requests) {
          if (
            !jQuery("a[data-shared=sharing-" + service + "-" + id + "]").length
          ) {
            continue;
          }
    ...
    inject_share_count: function(id, count) {
      ...
      $share.append(
        '<span class="share-count">' +
          WPCOMSharing.format_count(count) +
          "</span>"
      );
    },
  ...
  function WPCOMSharing_do() {
    ...
    $more_sharing_buttons.on("click", function() {
      var $more_sharing_button = $(this),
        $more_sharing_pane = $more_sharing_button
          .parents("div:first")
          .find(".inner");
      ...
      $more_sharing_pane
        .css({
          ...
          top:
            $more_sharing_button.position().top +
            $more_sharing_button.height() +
            3 +
            "px"
        })
        .slideToggle(200);
